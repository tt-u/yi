...
const messages: Record<Locale, Dict> = {
  en: {
    ...
    "hero.sub": "Select text in any app, press a shortcut, and Yi shows a natural DeepSeek translation right by your cursor — copied so you can paste your reply straight back.",
    "hero.download": "Download for free",
    "hero.github": "View on GitHub",

    "showcase.caption": "Select → ⌘Y → read the translation → ⌘V to paste it back",
    ...
    "f.instant.d": "Select text and press the shortcut — the translation streams in right beside your cursor, natural and idiomatic.",
    "f.convo.t": "Built for conversations",
    "f.convo.d": "Read a foreign message, then reply in their language. No more opening a translator, pasting, copying, pasting back.",
    "f.paste.t": "Paste & go",
    "f.paste.d": "The translation is copied automatically; press ⌘V to drop it back into the chat — the popup closes itself.",
    "f.source.t": "Free or your own key",
    "f.source.d": "Use the built-in relay for free, or switch to your own DeepSeek API key. Your choice, anytime.",
    "f.ui.t": "Bilingual & themed",
    "f.ui.d": "中 / EN interface, light / dark / system themes, and a fully customizable shortcut.",
    "f.privacy.t": "Private by default",
    "f.privacy.d": "With your own key, requests go straight to DeepSeek and the key never leaves your device.",

    "dl.title": "Download Yi",
    "dl.sub": "Free and open source. macOS builds are Apple-signed and notarized.",
    ...
    "dl.get": "Download",
    "dl.hint": "Not sure which Mac? Apple menu → About This Mac → look at \"Chip\". macOS opens on double-click; on Windows, click \"More info → Run anyway\" if SmartScreen appears.",
  ...
  zh: {
    ...
    "hero.title": "随处翻译。\n跨语言对话。",
    "hero.sub": "在任意应用选中文字，按一个快捷键，Yi 就在光标旁给出地道的 DeepSeek 译文 —— 还自动复制，直接 ⌘V 粘回去回复对方。",
    "hero.download": "免费下载",
    ...
    "f.convo.t": "为对话而生",
    "f.convo.d": "看懂外语消息，再用对方的语言回复。不必再开翻译、粘贴、复制、粘回。",
    "f.paste.t": "粘贴即用",
    "f.paste.d": "译文自动复制，按 ⌘V 直接粘回聊天框，弹窗随即自动关闭。",
    "f.source.t": "免费或自带 Key",
    "f.source.d": "默认用内置中转，免费开箱即用；也可随时切换到自己的 DeepSeek API Key。",
    "f.ui.t": "双语 · 主题",
    ...
    "dl.get": "下载",
    "dl.hint": "不确定 Mac 是哪种？点左上角苹果菜单 →「关于本机」看「芯片」。macOS 双击即可打开；Windows 若 SmartScreen 拦截，点「更多信息 → 仍要运行」。",
