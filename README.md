...
> 安装包**未做签名 / 公证**。
> macOS：首次打开提示「无法验证开发者」时，在「访达」里**右键 Yi.app → 打开**确认一次；或在「系统设置 → 隐私与安全性」里点「仍要打开」。
> Windows：SmartScreen 提示时点「更多信息 → 仍要运行」。

装好后从菜单栏托盘 / Dock 打开设置，填入 [DeepSeek API Key](https://platform.deepseek.com/api_keys)，选择语言对（默认中 ⇄ 英，支持 8 种语言）。然后在任意应用选中文字，按 `⌘Y` 翻译；译文已复制，按 `⌘V` 粘回原处。
